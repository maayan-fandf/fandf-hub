  ...
  return (
    <main className="container signin-container">
      <div className="signin-card">
        ...
        {error && (
          <div className="error">Sign-in failed: {error}</div>
        )}
        ...
        <p className="signin-note">
          After sign-in, Hub checks whether your email has access (admin or
          listed on a project). If not, you&apos;ll see a request-access screen.
        </p>
      </div>
    </main>
  );
