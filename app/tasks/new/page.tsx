        ...
        <div>
          ...
          <div className="subtitle">
            {commentSeed ? (
              ...
              <>
                ברירת המחדל — &quot;ממתין לטיפול&quot;. בעת יצירה: תיקיית ה־Drive
                שבחרת — או שאליה העלית קבצים — תקושר למשימה (אם לא נבחרה תיקייה,
                היא תיווצר אוטומטית בעת העלאת הקובץ הראשון), מייל למבצעים, ומשימה
                ב־Google Tasks לכל מבצע (מסומנת כהושלמה כשהמשימה עוברת
                ל-&quot;בוצע&quot;).
              </>
            )}
          </div>
