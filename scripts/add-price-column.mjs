/* eslint-disable */
// Adds the `price` column to the Comments tab — backs the new-task
// pricing field (Pricingsetup rate or manual amount, persisted on the
// task row alongside the PricingLog ledger). Idempotent: exits cleanly
// if the column already exists. Mirrors scripts/add-pending-complete-column.mjs.
