/* eslint-disable */
// One-off: appends a `description_history` column to the Comments tab
// header row so the task detail page can persist previous-body
// snapshots for the "task versions" feature. Idempotent — exits
// cleanly if the column already exists. Same shape as
// add-file-order-column.mjs.
//
// Run from hub-next/: node scripts/add-description-history-column.mjs
...
const NEW_HEADER = "description_history";
