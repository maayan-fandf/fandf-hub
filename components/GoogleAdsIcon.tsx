/**
 * Google Ads brand mark — the official multi-color logo (blue / yellow /
 * green swooshes), from uxwing's free icon set. Inlined as SVG so it
 * renders crisp at any size and inherits theme transitions without an
 * extra HTTP request. preserveAspectRatio keeps it undistorted even though
 * the artwork is slightly wider than tall.
 *
...
export default function GoogleAdsIcon({
  ...
  return (
    ...
    >
      ...
      <path
        fill="#34A852"
        d="M10.4,157.97c1.9-1.7,3.7-3.5,5.7-5.1c24.3-19.2,60.8-5.3,66.1,25.1c1.3,7.3,0.6,14.3-1.6,21.3c-0.1,0.6-0.2,1.1-0.4,1.7c-0.9,1.6-1.7,3.3-2.7,4.9c-8.9,14.7-22,22-39.2,20.9c-19.7-1.4-35.2-16.2-37.9-35.8c-1.3-9.5,0.6-18.4,5.5-26.6c1-1.8,2.2-3.4,3.3-5.2C9.7,158.77,9.5,157.97,10.4,157.97"
      />
      <path
        fill="#FABC04"
        d="M10.4,157.97c-0.4,0.4-0.4,1.1-1.1,1.2c-0.1-0.7,0.3-1.1,0.7-1.6L10.4,157.97"
      />
      <path
        fill="#E1C025"
        d="M80.2,200.97c-0.4-0.7,0-1.2,0.4-1.7c0.1,0.1,0.3,0.3,0.4,0.4L80.2,200.97"
      />
    </svg>
  );
}
