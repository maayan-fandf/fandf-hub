      ...
      {funnel.fbBreakdown ? (
        <details className="crm-fb-breakdown" dir="rtl">
          ...
          <p className="crm-fb-basis">
            לפי שיטת דו״ח יחסי-ההמרה של BMBY: לידים = נכנסו בטווח · תואמו/פגישות =
            כלל הפגישות (מצטבר עד היום) של לקוחות שפעילים בטווח — ליד או פגישה —
            לפי המודעה שהביאה אותם במגע הראשון. חי ממסע-הלקוח, עדכני יותר מטבלת
            הערוצים בחודש הנוכחי.
          </p>
