      ...
      {funnel.fbBreakdown ? (
        <details className="crm-fb-breakdown" dir="rtl">
          ...
          <p className="crm-fb-basis">
            לידים = נכנסו בטווח · תואמו/פגישות = פגישות בטווח, לפי המודעה שהביאה את
            הליד במגע הראשון (גם אם נכנס לפני הטווח). הנתונים חיים ממסע-הלקוח של
            BMBY — בחודש הנוכחי הם עשויים להקדים את טבלת הערוצים שמסתנכרנת לאט יותר.
          </p>
